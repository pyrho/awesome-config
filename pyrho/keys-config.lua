...
function hotkeys:init(args)
	...
	self.raw.root = {
        ...
        {
            { "Mod1" }, "j", function() awful.client.focus.byidx(1) end,
            {description = "focus next by index", group = "client"}
        },
        {
            { "Mod1" }, "k", function() awful.client.focus.byidx(-1) end,
            {description = "focus next by index", group = "client"}
        },
		{
	...
	self.raw.client = {
        ...
        {
            { env.mod , "Control" }, "Return", function(c) c:swap(awful.client.getmaster()) end,
			{ description = "Switch master", group = "Client keys" }
        },
        {
